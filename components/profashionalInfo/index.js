          ...
          <Grid
            ...
            <Grid
              ...
              <Grid className="pic-container" item sm={6} md={5} lg={4} xs={3}>
                <img
                  className="avatar"
                  style={{ backgroundImage: `url(${this.props.profAvatar})` }}
                  src={this.props.profAvatar}
                  alt="profashional-picture"
                />
              </Grid>
              <Grid
                ...
                lg={8}
                xs={6}>
                <Typography className="name" variant="title" fontSize="24px">
                  {this.props.profFirstName}
                </Typography>
                <Rate
            ...
            <Grid className="time-info" item sm={3} xs={12} container>
              <Grid
                ...
                <Grid className="date-pic" item xs={3}>
                  <img
                    className="avatar"
                    src="/static/svg/ic-today-24-px.svg"
                    alt="profashional-picture"
                  />
                </Grid>
                <Grid className="date" item xs={9}>
                  <Typography variant="subheading" fontSize="18px">
              ...
              <Grid
                ...
                <Grid className="access-time-pic" item xs={3}>
                  <img
                    className="avatar"
                    src="/static/svg/ic-access-time-24-px.svg"
                    alt="access-time"
                  />
                </Grid>
                <Grid className="access-time" item xs={9}>
                  <Typography variant="subheading" fontSize="18px">
                    {this.props.startTime.format('HH:mm')} -{' '}
                    {this.props.endTime.format('HH:mm')}
                  </Typography>
                </Grid>
              </Grid>
            </Grid>
